...
/***/ function(module, exports, __webpack_require__) {
	...
	var _homapage = __webpack_require__(14);
	
	var _homapage2 = _interopRequireDefault(_homapage);
	...
	function App() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      null,
	      _react2.default.createElement(_reactRouterDom.Route, { path: '/', element: _react2.default.createElement(_homapage2.default, null) }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _collectionItem = __webpack_require__(8);
	...
	var CollectionPreview = function CollectionPreview(_ref) {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ className: 'preview' },
				items.filter(function (item, idx) {
					return idx < 4;
				})
				//*.map(item => ( previously we used this, destructuring the props below
				.map(function (_ref2) {
					var id = _ref2.id,
					    otherItemProps = _objectWithoutProperties(_ref2, ['id']);
	
					return (
	
						//* <div key={item.id}>{item.name}</div> check out how we map below
						_react2.default.createElement(_collectionItem2.default, Object.assign({ key: id }, otherItemProps))
					);
				})
			)
		);
			...
			value: function render() {
				return _react2.default.createElement(
					...
					this.state.sections.map(function (_ref) {
						...
						return (//here we deconstruct the section properties
							_react2.default.createElement(_menuItem2.default, Object.assign({ key: id }, otherSectionProps))
						);
					})
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _crown = __webpack_require__(37);
	...
	var Header = function Header() {
		return _react2.default.createElement(
			'div',
			{ className: 'header' },
			_react2.default.createElement(_reactRouterDom.Link, { className: 'logo-container', to: '/' }),
			_react2.default.createElement(
				'div',
				{ className: 'options' },
				_react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	function withRouter(Component) {
		function ComponentWithRouterProp(props) {
			...
			return _react2.default.createElement(Component, Object.assign({}, props, {
	...
	exports.default = withRouter(Menuitem);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _directory = __webpack_require__(10);
	...
	var HomePage = function HomePage() {
	    ...
	    return _react2.default.createElement(
	        'div',
	        { className: 'homepage' },
	        _react2.default.createElement(_directory2.default, null)
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shopData = __webpack_require__(16);
	
	var _shopData2 = _interopRequireDefault(_shopData);
	
	var _collectionPreview = __webpack_require__(9);
	
	var _collectionPreview2 = _interopRequireDefault(_collectionPreview);
	...
	var ShopPage = function (_React$Component) {
		...
		function ShopPage(props) {
			...
			var _this = _possibleConstructorReturn(this, (ShopPage.__proto__ || Object.getPrototypeOf(ShopPage)).call(this, props));
	
			_this.state = {
				collections: _shopData2.default
			};
			return _this;
		}
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					collections.map(function (_ref) {
						var id = _ref.id,
						    theRest = _objectWithoutProperties(_ref, ['id']);
	
						return _react2.default.createElement(_collectionPreview2.default, Object.assign({ key: id }, theRest));
					})
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	'use strict';var aa=__webpack_require__(1),m=__webpack_require__(3),r=__webpack_require__(36);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * LICENSE file in the root directory of this source tree.
	 */
	'use strict';var l=__webpack_require__(3),n=60103,p=60106;exports.Fragment=60107;exports.StrictMode=60108;exports.Profiler=60114;var q=60109,r=60110,t=60112;exports.Suspense=60113;var u=60115,v=60116;
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
...
/***/ }
/******/ ])));
//# sourceMappingURL=main.672989e9.js.map